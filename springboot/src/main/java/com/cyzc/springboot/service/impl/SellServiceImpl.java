...
import com.cyzc.springboot.mapper.OrderMapper;
import com.cyzc.springboot.mapper.PrizeMapper;
import com.cyzc.springboot.mapper.PrizeRecordMapper;
import com.cyzc.springboot.mapper.ProductMapper;
import com.cyzc.springboot.service.SellService;
import com.cyzc.springboot.utils.PrizeTools;
   ...
   /* @Autowired 循环依赖了。
    ...
    public void sellProduct() {
        try {
            lock.lock();
            //使用aop代理获取代理对象调用方法
            ((SellServiceImpl) AopContext.currentProxy()).sellProductProcessor();
